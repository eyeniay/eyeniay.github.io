  ...
  (e.fn.headroom = function (t) {
    return this.each(function () {
      var o = e(this),
        a = o.data("headroom"),
        r = "object" == typeof t && t;
      (r = e.extend(!0, {}, Headroom.options, r)),
        a || ((a = new Headroom(this, r)).init(), o.data("headroom", a)),
        "string" == typeof t &&
          (a[t](), "destroy" === t && o.removeData("headroom"));
    });
  }),
    ...
    e(".navbar").headroom(),
    e(function () {
      e(".nav-link, .custom-btn-link").on("click", function (t) {
        document.getElementById("menuButton").click();
        var o = e(this);
        e("html, body")
          .stop()
          .animate({ scrollTop: e(o.attr("href")).offset().top - 49 }, 1e3),
          t.preventDefault();
      });
    }),
